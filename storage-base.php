...
<!-- Table -->
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Storage - Base</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <thead class="thead-inverse">
                        ...
                        $Query = " SELECT Storage_Base.Hostname,Storage_Base.Serial_Number,Storage_Base.Asset_tag_number,Storage_Base.Category,Storage_Base.Rack,Storage_Base.Branch FROM Storage_Base";
                        ...
                        class TableRows extends RecursiveIteratorIterator {
                         ...
                         if ($_GET['sort'] == 'Hostname')
                            ...
                            {
                                $Query .= " ORDER BY Storage-Base.Rack";
                            }
